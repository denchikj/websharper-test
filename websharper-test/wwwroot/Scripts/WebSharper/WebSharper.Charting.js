...
{
 "use strict";
 var WebSharper,Charting,Reactive,Pervasives,Color,Seq,Reactive$1,Charts,DataType,ChartConfig,SeriesChartConfig,ColorConfig,PolarData,Obj,LineChart,BarChart,RadarChart,PolarAreaChart,PieChart,DoughnutChart,CompositeChart,Chart,LiveChart,SC$1,Renderers,ChartJsInternal,BatchUpdater,ChartJs,SC$2,Util,Runtime,Seq$1,List,Control,FSharpEvent,Random,Arrays,Operators,Option,Slice,UI,Doc,AttrProxy,AttrModule;
